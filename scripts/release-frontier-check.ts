...
// Pilot blocker 2: the interview-method library employer read boundary is
// pending BY DESIGN until the owner applies it through the integration (the
// draft PR is not merged and nothing hosted was written from its session).
// Its name comes off this list in the same change that records the evidence.
