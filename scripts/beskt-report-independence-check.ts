...
const MIGRATION_NAME = "20261124090000_bcp_conduct_report_independence_boundary.sql";
const MIGRATION = `supabase/migrations/${MIGRATION_NAME}`;
const ROLLBACK =
  "supabase/rollback/20261124090000_bcp_conduct_report_independence_boundary_rollback.sql";
...
check(
  dbTest.includes("20261124090000_bcp_conduct_report_independence_boundary_rollback.sql") &&
    dbTest.includes("20261124090000_bcp_conduct_report_independence_boundary.sql"),
