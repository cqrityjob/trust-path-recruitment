...
const MUTATIONS: readonly Mutation[] = [
  ...
  /* ---- Boundaries E1 must not have weakened ------------------------ */
  {
    ...
    file: DICT,
    find: '    "continuity.assessment.brief_released": "Kandidatunderlag delat",',
    replace: '    "continuity.assessment.brief_released": "Verifierad kompetens",',
    guard: E1,
    expect: '15 · "continuity.assessment.brief_released" makes no verification claim',
  },
  {
