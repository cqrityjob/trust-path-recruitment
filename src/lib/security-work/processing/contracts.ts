...
export const SW_AI_TASK_VERSION = "sw-analysis-1.0.0";
export const SW_AI_PROMPT_VERSION = "sw-analysis-prompt-1.0.0";
export const SW_AI_POLICY_VERSION = "sw-analysis-policy-1.0.0";
