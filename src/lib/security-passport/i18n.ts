...
const sv = {
  ...
  "live.selfReportedOnly":
    "Allt du lägger in nu är egenrapporterat. Verifiering av arbetsgivare och utfärdare kommer i ett senare steg — inget här är verifierat ännu.",
  ...
  "live.cancel": "Avbryt",
  "live.added": "Tillagd",
  "live.noVerificationYet": "Verifiering är inte tillgänglig ännu",
  "live.noVerificationBody":
    "I ett senare steg kan en behörig arbetsgivare eller utfärdare bekräfta dina uppgifter. Då — och först då — kan en uppgift bli verifierad.",
...
const en: Record<PassportCopyKey, string> = {
  ...
  "live.selfReportedOnly":
    "Everything you add now is self-reported. Verification by employers and issuers comes in a later step — nothing here is verified yet.",
  ...
  "live.cancel": "Cancel",
  "live.added": "Added",
  "live.noVerificationYet": "Verification is not available yet",
  "live.noVerificationBody":
    "In a later step an authorised employer or issuer will be able to confirm your entries. Then — and only then — can an entry become verified.",
