...
export const dictionaries = {
  sv: {
    ...
    // ── TRUST Evidence Report (PR-R3B): the employer page ──────────────
    "report.trust.breadcrumb.assessments": "Bedömningar",
    "report.trust.breadcrumb.candidate": "Kandidat",
    "report.trust.breadcrumb.report": "TRUST Evidence Report",
    "report.trust.title": "TRUST Evidence Report",
    "report.trust.decisionSupport": "Beslutsstöd för fortsatt mänsklig bedömning.",
    "report.trust.humanReviewed": "Mänsklig granskning slutförd",
    "report.trust.humanReviewPending": "Mänsklig granskning pågår",
    "report.trust.status.released": "Rapport färdigställd",
    "report.trust.meta.released": "Rapport färdigställd",
    "report.trust.meta.employer": "Beställande arbetsgivare",
    "report.trust.meta.candidate": "Kandidat",
    "report.trust.meta.participantRef": "Deltagarreferens",
    "report.trust.meta.reportId": "Rapport-ID",
    "report.trust.action.print": "Skriv ut / Spara som PDF",
    "report.trust.action.printShort": "Skriv ut / PDF",
    "report.trust.action.more": "Mer",
    "report.trust.action.backToCandidate": "Tillbaka till kandidaten",
    "report.trust.masthead.tagline": "Where trust comes first.",
    "report.trust.humanReviewedSub": "Obligatoriska granskningar slutförda",
    "report.trust.addenda.liveTitle": "Levande information",
    "report.trust.addenda.liveSub": "Ingår inte i den frysta rapporten.",
    "report.trust.action.share": "Dela internt",
    "report.trust.action.shared": "Länk kopierad",
    "report.trust.action.startInterview": "Starta strukturerad intervju",
    "report.trust.action.openPlan": "Öppna intervjuplanen",
    "report.trust.action.backToList": "Tillbaka till kandidatlistan",
    "report.trust.overview.heading": "Det här är viktigast inför nästa steg",
    "report.trust.overview.nextStep": "Nästa steg i processen",
    "report.trust.overview.step.structured_interview": "Strukturerad intervju",
    "report.trust.overview.step.additional_assessment": "Kompletterande bedömning",
    "report.trust.overview.step.request_clarification": "Följ upp innan nästa steg",
    "report.trust.overview.step.gather_more_evidence": "Samla mer underlag",
    "report.trust.overview.stepIsProcess":
      "Ett processteg, inte ett omdöme om kandidaten. Beslutet är arbetsgivarens.",
    "report.trust.overview.col.support": "Tydligast observerat stöd",
    "report.trust.overview.col.verify": "Verifiera i intervju",
    "report.trust.overview.col.limited": "Begränsat underlag",
    "report.trust.overview.col.supportHint": "Jämnt mönster i svaren och tillräckligt underlag.",
    "report.trust.overview.col.verifyHint": "Områden att följa upp i samtalet.",
    "report.trust.overview.col.limitedHint":
      "För få observerade uppgifter för att fastställa ett mönster. Det säger inget om kompetensen.",
    "report.trust.overview.empty.support":
      "Inget område har både ett jämnt mönster i svaren och tillräckligt underlag.",
    "report.trust.overview.empty.verify": "Inga områden är markerade för uppföljning.",
    "report.trust.overview.empty.limited": "Alla områden har tillräckligt observerat underlag.",
    "report.trust.overview.safety": "Säkerhetskritisk uppföljning finns",
    "report.trust.overview.safetyLink": "Se avsnittet Säkerhetskritisk uppföljning.",
    "report.trust.overview.limitationLead": "Underlaget i korthet",
    "report.trust.overview.focusAreas": "Fokusområden för nästa steg",
    "report.trust.axis.pattern": "Mönster i observerade svar",
    "report.trust.axis.evidence": "Underlag",
    "report.trust.axis.next": "Nästa steg",
    "report.trust.pattern.clearly_consistent": "Tydligt konsekvent",
    "report.trust.pattern.consistent": "Konsekvent",
    "report.trust.pattern.mixed": "Blandat",
    "report.trust.pattern.developing": "Under utveckling",
    "report.trust.pattern.not_established": "Inte fastställt",
    "report.trust.sufficiency.sufficient": "Tillräckligt underlag",
    "report.trust.sufficiency.limited": "Begränsat underlag",
    "report.trust.sufficiency.none": "Inget observerat underlag",
    "report.trust.priority.first": "Följ upp först",
    "report.trust.priority.next": "Följ upp i intervju",
    "report.trust.priority.if_time_allows": "Kan följas upp vid behov",
    "report.trust.priority.none": "Ingen särskild uppföljning",
    "report.trust.items.one": "observerad uppgift",
    "report.trust.items.other": "observerade uppgifter",
    "report.trust.of": "av",
    "report.trust.notAvailable": "Ej tillgängligt",
    "report.trust.observedLabel": "Observerat",
    "report.trust.safetyFollowUp": "Säkerhetskritisk uppföljning",
    "report.trust.map.heading": "Kompetensområden och underlag",
    "report.trust.map.lede":
      "Åtta kompetensområden. Varje kort håller isär mönstret i svaren, underlagets omfattning och nästa steg.",
    "report.trust.map.empty": "Rapporten innehåller inga kompetensområden.",
    "report.trust.map.expand": "Visa detaljer",
    "report.trust.map.collapse": "Dölj detaljer",
    "report.trust.map.observed": "Observerade uppgifter",
    "report.trust.map.behaviour": "Beteende i fokus",
    "report.trust.map.scope": "Underlagets omfattning",
    "report.trust.map.scope.scenario": "Scenariouppgifter",
    "report.trust.map.scope.freeText": "Fritextsvar",
    "report.trust.map.scope.selfDescription": "Självbeskrivning",
    "report.trust.map.scope.contexts": "Observerade sammanhang",
    "report.trust.map.scope.answered": "Besvarade uppgifter i området",
    "report.trust.map.scope.unavailable":
      "Omfattningen per område kan inte visas för den här rapporten. Den skapades innan det detaljerade underlaget sparades.",
    "report.trust.map.selfReport": "Kandidatens egen beskrivning",
    "report.trust.map.selfReportTag": "Självbeskrivning — inte observerad evidens",
    "report.trust.map.selfReportNone": "Ingen självbeskrivning är kopplad till området.",
    "report.trust.map.reviewed": "Mänskligt granskat fritextunderlag",
    "report.trust.map.reviewedNone": "Inga fritextsvar i det här området.",
    "report.trust.map.reviewedWord": "granskade fritextsvar",
    "report.trust.map.reviewStatus.completed": "Granskning slutförd",
    "report.trust.map.reviewStatus.pending": "Granskning pågår",
    "report.trust.map.reviewStatus.not_required": "Ingen granskning krävdes",
    "report.trust.map.limitations": "Begränsningar",
    "report.trust.map.limitationsNone":
      "Inga områdesspecifika begränsningar utöver rapportens allmänna.",
    "report.trust.map.question": "TRUST-fråga",
    "report.trust.map.questionNone": "Ingen förberedd fråga för området.",
    "report.trust.map.followup": "Följdfråga",
    "report.trust.map.listenFor": "Lyssna efter",
    "report.trust.map.traceability": "Spårbarhet",
    "report.trust.map.traceable": "Beräkningskedjan för området är verifierad och kan spåras.",
    "report.trust.map.notTraceable": "Spårbarhet kan inte visas för den här rapporten.",
    "report.trust.map.addenda": "Intervjutillägg",
    "report.trust.flag.single_context": "Ett observerat sammanhang",
    "report.trust.flag.single_item": "En observerad uppgift",
    "report.trust.flag.self_report_not_observed": "Självbeskrivning är inte observerat underlag",
    "report.trust.flag.descriptive_only": "Beskrivande, inte observerat",
    "report.trust.flag.methodologically_open": "Öppet för tolkning",
    "report.trust.flag.unvalidated_content": "Pilotversion — ännu inte validerad",
    "report.trust.flag.closed_test": "Stängd pilot",
    "report.trust.reason.safety_finding": "Säkerhetsrelaterad uppföljningspunkt",
    "report.trust.reason.developing_pattern": "Mönstret är under utveckling",
    "report.trust.reason.mixed_pattern": "Blandat mönster i svaren",
    "report.trust.reason.limited_evidence": "Begränsat underlag",
    "report.trust.reason.pending_review": "Granskning pågår",
    "report.trust.reason.human_review_adjusted": "Justerat efter mänsklig granskning",
    "report.trust.self.heading": "Kandidatens egen beskrivning",
    "report.trust.self.lede":
      "Så beskriver kandidaten själv sitt arbetssätt. Beskrivande uppgifter, inte observerade svar.",
    "report.trust.self.pattern.consistently_described": "Beskrivs genomgående",
    "report.trust.self.pattern.mostly_described": "Beskrivs oftast",
    "report.trust.self.pattern.rarely_described": "Beskrivs sällan",
    "report.trust.self.pattern.not_described": "Beskrivs inte",
    "report.trust.self.consistency.consistent": "Enhetligt",
    "report.trust.self.consistency.varied": "Varierat",
    "report.trust.self.questions.one": "fråga",
    "report.trust.self.questions.other": "frågor",
    "report.trust.self.empty": "Ingen självbeskrivning ingår i den här rapporten.",
    "report.trust.safety.heading": "Säkerhetskritisk uppföljning",
    "report.trust.safety.employerOnly": "Endast arbetsgivaren",
    "report.trust.safety.meaning":
      "Det här innebär att området ska följas upp. Det är inte en bedömning av kandidaten som säkerhetsrisk.",
    "report.trust.safety.source": "Källa: mänsklig granskning av fritextsvar.",
    "report.trust.safety.findingsLabel": "Uppföljningspunkter",
    "report.trust.safety.findings.one": "uppföljningspunkt",
    "report.trust.safety.findings.other": "uppföljningspunkter",
    "report.trust.safety.areas": "Områden att följa upp",
    "report.trust.safety.observedAt": "Registrerad",
    "report.trust.safety.reviewedCount": "säkerhetskritiska svar granskade",
    "report.trust.plan.heading": "TRUST Interview Plan",
    "report.trust.plan.subheading": "Från evidens till en bättre intervju.",
    "report.trust.plan.know": "Det här vet vi",
    "report.trust.plan.unclear": "Det här behöver klargöras",
    "report.trust.plan.question": "Huvudfråga",
    "report.trust.plan.listen": "Lyssna efter",
    "report.trust.plan.structure": "Struktur för samtalet",
    "report.trust.plan.document": "Dokumentera",
    "report.trust.plan.showStructure": "Visa samtalsstruktur",
    "report.trust.plan.hideStructure": "Dölj samtalsstruktur",
    "report.trust.plan.questionsWord": "förberedda frågor i planen",
    "report.trust.plan.empty": "Ingen intervjuplan kunde byggas för den här rapporten.",
    "report.trust.plan.unclear.explore_limited_evidence":
      "Få observerade uppgifter. Mönstret är inte fastställt.",
    "report.trust.plan.unclear.explore_self_report":
      "Uppgiften kommer från kandidaten själv och är inte observerad.",
    "report.trust.plan.unclear.explore_development":
      "Mönstret i svaren varierar. Vad som avgör utfallet är inte klarlagt.",
    "report.trust.plan.unclear.confirm_strength":
      "Underlaget är jämnt. Intervjun kan bekräfta det med ett konkret exempel.",
    "report.trust.addenda.heading": "Intervjutillägg",
    "report.trust.addenda.live": "Levande information — ingår inte i den frysta rapporten.",
    "report.trust.addenda.asOf": "Uppdaterat",
    "report.trust.addenda.empty": "Inga intervjutillägg ännu.",
    "report.trust.addenda.status.supported_in_interview": "Stöds i intervju",
    "report.trust.addenda.status.not_supported_in_interview": "Stöds inte i intervju",
    "report.trust.addenda.status.additional_context": "Ytterligare kontext",
    "report.trust.addenda.add": "Lägg till tillägg",
    "report.trust.addenda.area": "Område",
    "report.trust.addenda.status": "Status",
    "report.trust.addenda.note": "Anteckning",
    "report.trust.addenda.save": "Spara tillägg",
    "report.trust.addenda.saving": "Sparar…",
    "report.trust.addenda.failed": "Tillägget kunde inte sparas. Försök igen.",
    "report.trust.addenda.inert":
      "Tillägg ändrar inte den färdigställda rapporten och räknas aldrig ihop med underlaget.",
    "report.trust.method.heading": "Om rapporten",
    "report.trust.method.sub": "Metod och spårbarhet",
    "report.trust.method.show": "Visa metod och spårbarhet",
    "report.trust.method.hide": "Dölj metod och spårbarhet",
    "report.trust.method.versions": "Versioner",
    "report.trust.method.assessmentVersion": "Bedömningsversion",
    "report.trust.method.scoringModel": "Beräkningsmodell",
    "report.trust.method.rubric": "Bedömningsmallar",
    "report.trust.method.reportTemplate": "Rapportmall",
    "report.trust.method.core": "Rapportkärna",
    "report.trust.method.chain": "Beräkningskedja",
    "report.trust.method.chain.verified": "Verifierad",
    "report.trust.method.chain.legacy": "Äldre rapport — beräkningskedjan kan inte verifieras",
    "report.trust.method.humanReview": "Mänsklig granskning",
    "report.trust.method.reviewsDone": "obligatoriska granskningar slutförda",
    "report.trust.method.coverage": "Omfattning",
    "report.trust.method.selfItems": "Frågor om eget arbetssätt",
    "report.trust.method.areasSufficient": "Områden med tillräckligt underlag",
    "report.trust.method.areasLimited": "Områden med begränsat underlag",
    "report.trust.method.sufficiencyRule": "Så definieras tillräckligt underlag",
    "report.trust.method.templateNow": "Aktuell vägledning från rapportmallen — inte fryst",
    "report.trust.method.templateAsOf": "per",
    "report.trust.method.calculatedAt": "Beräknad",
    "report.trust.sufficiency.sufficientLong": "Tillräckligt underlag för tolkning",
    "report.trust.sufficiency.limitedLong": "Begränsat underlag för tolkning",
    "report.trust.map.scope.freeTextReviewed": "Granskade fritextsvar",
    "report.trust.plan.knowObserved": "Det här finns i underlaget",
    "report.trust.plan.knowSelfReported": "Det här uppger kandidaten",
    "report.trust.safety.lede":
      "Ett svar inom ett säkerhetskritiskt område har identifierats för uppföljning i intervju.",
    "report.trust.print.part1": "Del 1 — Arbetsgivarrapport",
    "report.trust.print.part2": "Del 2 — Underlagsbilaga",
    "report.trust.print.part1Lede":
      "Sammanfattning, uppföljning och intervjuplan. Det fullständiga underlaget finns i bilagan.",
    "report.trust.print.part2Lede":
      "Fullständigt underlag per kompetensområde, kandidatens egen beskrivning och teknisk spårbarhet.",
    "report.trust.summary.heading": "Kompetensområden i korthet",
    "report.trust.summary.area": "Kompetensområde",
    "report.trust.provenance.heading": "Teknisk spårbarhet",
    "report.trust.provenance.lede":
      "Versioner och identiteter för granskning och revision. Behövs inte för att läsa rapporten.",
    "report.trust.error.title": "Rapporten kunde inte läsas",
    "report.trust.error.body": "Försök igen om en stund. Om det inte hjälper, kontakta support.",
  ...
  en: {
    ...
    // ── TRUST Evidence Report (PR-R3B): the employer page ──────────────
    "report.trust.breadcrumb.assessments": "Assessments",
    "report.trust.breadcrumb.candidate": "Candidate",
    "report.trust.breadcrumb.report": "TRUST Evidence Report",
    "report.trust.title": "TRUST Evidence Report",
    "report.trust.decisionSupport": "Decision support for continued human judgement.",
    "report.trust.humanReviewed": "Human review completed",
    "report.trust.humanReviewPending": "Human review in progress",
    "report.trust.status.released": "Report completed",
    "report.trust.meta.released": "Report completed",
    "report.trust.meta.employer": "Commissioning employer",
    "report.trust.meta.candidate": "Candidate",
    "report.trust.meta.participantRef": "Participant reference",
    "report.trust.meta.reportId": "Report ID",
    "report.trust.action.print": "Print / Save as PDF",
    "report.trust.action.printShort": "Print / PDF",
    "report.trust.action.more": "More",
    "report.trust.action.backToCandidate": "Back to the candidate",
    "report.trust.masthead.tagline": "Where trust comes first.",
    "report.trust.humanReviewedSub": "Mandatory reviews completed",
    "report.trust.addenda.liveTitle": "Live information",
    "report.trust.addenda.liveSub": "Not part of the frozen report.",
    "report.trust.action.share": "Share internally",
    "report.trust.action.shared": "Link copied",
    "report.trust.action.startInterview": "Start structured interview",
    "report.trust.action.openPlan": "Open the interview plan",
    "report.trust.action.backToList": "Back to the candidate list",
    "report.trust.overview.heading": "What matters most before the next step",
    "report.trust.overview.nextStep": "Next step in the process",
    "report.trust.overview.step.structured_interview": "Structured interview",
    "report.trust.overview.step.additional_assessment": "Additional assessment",
    "report.trust.overview.step.request_clarification": "Follow up before the next step",
    "report.trust.overview.step.gather_more_evidence": "Gather more evidence",
    "report.trust.overview.stepIsProcess":
      "A process step, not a judgement of the candidate. The decision is the employer's.",
    "report.trust.overview.col.support": "Clearest observed support",
    "report.trust.overview.col.verify": "Verify in interview",
    "report.trust.overview.col.limited": "Limited evidence",
    "report.trust.overview.col.supportHint":
      "An even pattern in the answers and sufficient evidence.",
    "report.trust.overview.col.verifyHint": "Areas to follow up in the conversation.",
    "report.trust.overview.col.limitedHint":
      "Too few observed tasks to establish a pattern. It says nothing about the competency.",
    "report.trust.overview.empty.support":
      "No area has both an even pattern in the answers and sufficient evidence.",
    "report.trust.overview.empty.verify": "No areas are marked for follow-up.",
    "report.trust.overview.empty.limited": "Every area has sufficient observed evidence.",
    "report.trust.overview.safety": "Safety-critical follow-up is present",
    "report.trust.overview.safetyLink": "See the section Safety-critical follow-up.",
    "report.trust.overview.limitationLead": "The evidence in brief",
    "report.trust.overview.focusAreas": "Focus areas for the next step",
    "report.trust.axis.pattern": "Pattern in observed answers",
    "report.trust.axis.evidence": "Evidence",
    "report.trust.axis.next": "Next step",
    "report.trust.pattern.clearly_consistent": "Clearly consistent",
    "report.trust.pattern.consistent": "Consistent",
    "report.trust.pattern.mixed": "Mixed",
    "report.trust.pattern.developing": "Developing",
    "report.trust.pattern.not_established": "Not established",
    "report.trust.sufficiency.sufficient": "Sufficient evidence",
    "report.trust.sufficiency.limited": "Limited evidence",
    "report.trust.sufficiency.none": "No observed evidence",
    "report.trust.priority.first": "Follow up first",
    "report.trust.priority.next": "Follow up in interview",
    "report.trust.priority.if_time_allows": "Can be followed up if needed",
    "report.trust.priority.none": "No specific follow-up",
    "report.trust.items.one": "observed task",
    "report.trust.items.other": "observed tasks",
    "report.trust.of": "of",
    "report.trust.notAvailable": "Not available",
    "report.trust.observedLabel": "Observed",
    "report.trust.safetyFollowUp": "Safety-critical follow-up",
    "report.trust.map.heading": "Competency areas and evidence",
    "report.trust.map.lede":
      "Eight competency areas. Each card keeps the pattern in the answers, the scope of the evidence and the next step apart.",
    "report.trust.map.empty": "The report contains no competency areas.",
    "report.trust.map.expand": "Show details",
    "report.trust.map.collapse": "Hide details",
    "report.trust.map.observed": "Observed tasks",
    "report.trust.map.behaviour": "Behaviour in focus",
    "report.trust.map.scope": "Scope of the evidence",
    "report.trust.map.scope.scenario": "Scenario tasks",
    "report.trust.map.scope.freeText": "Free-text answers",
    "report.trust.map.scope.selfDescription": "Self-description",
    "report.trust.map.scope.contexts": "Observed contexts",
    "report.trust.map.scope.answered": "Answered tasks in this area",
    "report.trust.map.scope.unavailable":
      "The scope per area cannot be shown for this report. It was created before the detailed evidence was stored.",
    "report.trust.map.selfReport": "The candidate's own description",
    "report.trust.map.selfReportTag": "Self-description — not observed evidence",
    "report.trust.map.selfReportNone": "No self-description is linked to this area.",
    "report.trust.map.reviewed": "Human-reviewed free-text evidence",
    "report.trust.map.reviewedNone": "No free-text answers in this area.",
    "report.trust.map.reviewedWord": "reviewed free-text answers",
    "report.trust.map.reviewStatus.completed": "Review completed",
    "report.trust.map.reviewStatus.pending": "Review in progress",
    "report.trust.map.reviewStatus.not_required": "No review was required",
    "report.trust.map.limitations": "Limitations",
    "report.trust.map.limitationsNone":
      "No area-specific limitations beyond the report's general ones.",
    "report.trust.map.question": "TRUST question",
    "report.trust.map.questionNone": "No prepared question for this area.",
    "report.trust.map.followup": "Follow-up question",
    "report.trust.map.listenFor": "Listen for",
    "report.trust.map.traceability": "Traceability",
    "report.trust.map.traceable":
      "The calculation chain for this area is verified and can be traced.",
    "report.trust.map.notTraceable": "Traceability cannot be shown for this report.",
    "report.trust.map.addenda": "Interview addenda",
    "report.trust.flag.single_context": "One observed context",
    "report.trust.flag.single_item": "One observed task",
    "report.trust.flag.self_report_not_observed": "Self-description is not observed evidence",
    "report.trust.flag.descriptive_only": "Descriptive, not observed",
    "report.trust.flag.methodologically_open": "Open to interpretation",
    "report.trust.flag.unvalidated_content": "Pilot version — not yet validated",
    "report.trust.flag.closed_test": "Closed pilot",
    "report.trust.reason.safety_finding": "Safety-related follow-up point",
    "report.trust.reason.developing_pattern": "The pattern is still developing",
    "report.trust.reason.mixed_pattern": "Mixed pattern in the answers",
    "report.trust.reason.limited_evidence": "Limited evidence",
    "report.trust.reason.pending_review": "Review in progress",
    "report.trust.reason.human_review_adjusted": "Adjusted after human review",
    "report.trust.self.heading": "The candidate's own description",
    "report.trust.self.lede":
      "How the candidate describes their own way of working. Descriptive statements, not observed answers.",
    "report.trust.self.pattern.consistently_described": "Consistently described",
    "report.trust.self.pattern.mostly_described": "Mostly described",
    "report.trust.self.pattern.rarely_described": "Rarely described",
    "report.trust.self.pattern.not_described": "Not described",
    "report.trust.self.consistency.consistent": "Consistent",
    "report.trust.self.consistency.varied": "Varied",
    "report.trust.self.questions.one": "question",
    "report.trust.self.questions.other": "questions",
    "report.trust.self.empty": "No self-description is included in this report.",
    "report.trust.safety.heading": "Safety-critical follow-up",
    "report.trust.safety.employerOnly": "Employer only",
    "report.trust.safety.meaning":
      "This means the area should be followed up. It is not an assessment of the candidate as a safety risk.",
    "report.trust.safety.source": "Source: human review of free-text answers.",
    "report.trust.safety.findingsLabel": "Follow-up points",
    "report.trust.safety.findings.one": "follow-up point",
    "report.trust.safety.findings.other": "follow-up points",
    "report.trust.safety.areas": "Areas to follow up",
    "report.trust.safety.observedAt": "Recorded",
    "report.trust.safety.reviewedCount": "safety-critical answers reviewed",
    "report.trust.plan.heading": "TRUST Interview Plan",
    "report.trust.plan.subheading": "From evidence to a better interview.",
    "report.trust.plan.know": "What we know",
    "report.trust.plan.unclear": "This needs to be clarified",
    "report.trust.plan.question": "Main question",
    "report.trust.plan.listen": "Listen for",
    "report.trust.plan.structure": "Structure for the conversation",
    "report.trust.plan.document": "Document",
    "report.trust.plan.showStructure": "Show conversation structure",
    "report.trust.plan.hideStructure": "Hide conversation structure",
    "report.trust.plan.questionsWord": "prepared questions in the plan",
    "report.trust.plan.empty": "No interview plan could be built for this report.",
    "report.trust.plan.unclear.explore_limited_evidence":
      "Few observed tasks. The pattern is not established.",
    "report.trust.plan.unclear.explore_self_report":
      "The statement comes from the candidate and is not observed.",
    "report.trust.plan.unclear.explore_development":
      "The pattern in the answers varies. What decides the outcome is not clear.",
    "report.trust.plan.unclear.confirm_strength":
      "The evidence is even. The interview can confirm it with a concrete example.",
    "report.trust.addenda.heading": "Interview addenda",
    "report.trust.addenda.live": "Live information — not part of the frozen report.",
    "report.trust.addenda.asOf": "Updated",
    "report.trust.addenda.empty": "No interview addenda yet.",
    "report.trust.addenda.status.supported_in_interview": "Supported in interview",
    "report.trust.addenda.status.not_supported_in_interview": "Not supported in interview",
    "report.trust.addenda.status.additional_context": "Additional context",
    "report.trust.addenda.add": "Add an addendum",
    "report.trust.addenda.area": "Area",
    "report.trust.addenda.status": "Status",
    "report.trust.addenda.note": "Note",
    "report.trust.addenda.save": "Save addendum",
    "report.trust.addenda.saving": "Saving…",
    "report.trust.addenda.failed": "The addendum could not be saved. Try again.",
    "report.trust.addenda.inert":
      "Addenda do not change the completed report and are never counted into the evidence.",
    "report.trust.method.heading": "About the report",
    "report.trust.method.sub": "Method and traceability",
    "report.trust.method.show": "Show method and traceability",
    "report.trust.method.hide": "Hide method and traceability",
    "report.trust.method.versions": "Versions",
    "report.trust.method.assessmentVersion": "Assessment version",
    "report.trust.method.scoringModel": "Calculation model",
    "report.trust.method.rubric": "Rubric editions",
    "report.trust.method.reportTemplate": "Report template",
    "report.trust.method.core": "Report core",
    "report.trust.method.chain": "Calculation chain",
    "report.trust.method.chain.verified": "Verified",
    "report.trust.method.chain.legacy": "Legacy report — the calculation chain cannot be verified",
    "report.trust.method.humanReview": "Human review",
    "report.trust.method.reviewsDone": "mandatory reviews completed",
    "report.trust.method.coverage": "Coverage",
    "report.trust.method.selfItems": "Questions about own way of working",
    "report.trust.method.areasSufficient": "Areas with sufficient evidence",
    "report.trust.method.areasLimited": "Areas with limited evidence",
    "report.trust.method.sufficiencyRule": "How sufficient evidence is defined",
    "report.trust.method.templateNow": "Current guidance from the report template — not frozen",
    "report.trust.method.templateAsOf": "as of",
    "report.trust.method.calculatedAt": "Calculated",
    "report.trust.sufficiency.sufficientLong": "Sufficient evidence to interpret",
    "report.trust.sufficiency.limitedLong": "Limited evidence to interpret",
    "report.trust.map.scope.freeTextReviewed": "Reviewed free-text answers",
    "report.trust.plan.knowObserved": "This is in the evidence",
    "report.trust.plan.knowSelfReported": "This is what the candidate states",
    "report.trust.safety.lede":
      "An answer within a safety-critical area has been identified for follow-up in the interview.",
    "report.trust.print.part1": "Part 1 — Employer report",
    "report.trust.print.part2": "Part 2 — Evidence appendix",
    "report.trust.print.part1Lede":
      "Summary, follow-up and interview plan. The full evidence is in the appendix.",
    "report.trust.print.part2Lede":
      "Full evidence per competency area, the candidate's own description and technical traceability.",
    "report.trust.summary.heading": "Competency areas at a glance",
    "report.trust.summary.area": "Competency area",
    "report.trust.provenance.heading": "Technical traceability",
    "report.trust.provenance.lede":
      "Versions and identities for review and audit. Not needed to read the report.",
    "report.trust.error.title": "The report could not be read",
    "report.trust.error.body": "Try again in a moment. If that does not help, contact support.",
