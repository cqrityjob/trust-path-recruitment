...
export const dictionaries = {
  ...
  en: {
    ...
    "sca.next.explore.body": "Learn more about security roles and their requirements.",
    "sca.next.jobs.title": "Browse security jobs",
    "sca.next.jobs.body": "See opportunities across the security industry.",
    "sca.next.guide.title": "Learn about the profession",
    "sca.next.guide.body": "Go deeper on your top career match.",
