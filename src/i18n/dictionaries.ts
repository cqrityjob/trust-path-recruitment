...
export const dictionaries = {
  sv: {
    ...
    "academy.library.sections.developmentLede": "Program som ännu inte kan tilldelas.",
  ...
  en: {
    ...
    "academy.library.sections.developmentLede": "Programmes that cannot be assigned yet.",
