...
export const dictionaries = {
  sv: {
    ...
    "iiu.lv.notes.hint":
      "Skriv vad som faktiskt sades. Anteckningen är källmaterial — inget här blir evidens förrän du bekräftar det i granskningen.",
    "iiu.lv.saved": "Sparat",
    ...
    "iiu.lv.cat.followup": "Följ upp",
    "iiu.lv.cat.followup.none": "Inga godkända följdfrågor för den här frågan.",
  ...
  en: {
    ...
    "iiu.lv.notes.hint":
      "Write down what was actually said. The note is source material — nothing here becomes evidence until you confirm it in review.",
    "iiu.lv.saved": "Saved",
    ...
    "iiu.lv.cat.followup": "Follow up",
    "iiu.lv.cat.followup.none": "No approved follow-ups for this question.",
