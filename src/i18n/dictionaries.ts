...
export const dictionaries = {
  sv: {
    ...
    "sca.next.guide.title": "Öppna yrkesguiden",
    "sca.next.guide.body": "Fördjupa dig i din främsta matchning.",
    "sca.next.explore.title": "Utforska karriärer",
    "sca.next.explore.body": "Bläddra bland roller och yrkesfamiljer.",
    "sca.next.jobs.title": "Bläddra bland jobb",
    "sca.next.jobs.body": "Framtida jobbportal — under utveckling.",
  ...
  en: {
    ...
    "sca.next.guide.title": "Open profession guide",
    "sca.next.guide.body": "Dive deeper into your top match.",
    "sca.next.explore.title": "Explore careers",
    "sca.next.explore.body": "Browse roles and profession families.",
    "sca.next.jobs.title": "Browse jobs",
    "sca.next.jobs.body": "Future jobs portal — in development.",
