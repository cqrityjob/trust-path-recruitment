...
export const dictionaries = {
  sv: {
    ...
    "iiu.ev.s3.title": "3. Mänsklig bedömning",
    "iiu.ev.s3.body":
      "En bedömning görs mot paketets ankare och kräver en skriven motivering. Det finns ingen totalpoäng, ingen viktning och ingen rangordning.",
    "iiu.ev.confirmedcount": "bekräftad evidens",
  ...
  en: {
    ...
    "iiu.ev.s3.title": "3. Human assessment",
    "iiu.ev.s3.body":
      "An assessment is made against the package's behavioural examples and requires written reasoning. There is no total score, no weighting and no ranking.",
    "iiu.ev.confirmedcount": "confirmed evidence",
