...
FROM (VALUES
  ...
  -- Eligibility, separately, because "licence active" is a different question
  ...
  -- Education. A qualification produces THIS and only this.
...
-- Non-front-line is deliberately absent from the active titles above. It is a
-- licence to hold a role in a licensed business, not a licence to perform a
-- front-line security activity, and giving it a professional title would
-- assert something about what its holder may do on a door.
