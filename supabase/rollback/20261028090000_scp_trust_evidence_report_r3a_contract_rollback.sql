...
--
-- Drops the one function the migration created. Nothing else was created,
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_proc p JOIN pg_namespace n ON n.oid = p.pronamespace
    ...
    RAISE EXCEPTION 'SCP_R3A_ROLLBACK: scp_employer_report_v3 survived';
  END IF;
  ...
  END IF;
  RAISE NOTICE 'PR-R3A rolled back: scp_employer_report_v3 dropped; audience contracts, release function and snapshots untouched';
END
$proof$;
