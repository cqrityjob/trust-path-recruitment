...
INSERT INTO public.sp_claims(id,holder_user_id,claim_type,credential_code,title,claimed_issuer_name,issued_on)
 VALUES ('f1800000-0000-4000-8000-000000000011','f1800000-0000-4000-8000-000000000001','certification','INTL_ASIS_CPP','Certified Protection Professional (CPP)','ASIS International','2026-01-01');
INSERT INTO public.sp_credential_details(claim_id,credential_class,original_language,issuing_country_code,no_expiry)
 VALUES ('f1800000-0000-4000-8000-000000000011','certification',NULL,NULL,false);
...
SELECT pg_temp.refused($q$UPDATE public.sp_credential_details SET no_expiry=true WHERE id='f1800000-0000-4000-8000-000000000011'$q$,'no-expiry requires catalogue approval');
