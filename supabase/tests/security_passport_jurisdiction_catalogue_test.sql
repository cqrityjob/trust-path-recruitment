...
BEGIN
  ...
  -- =====================================================================
  -- Every claim below names a credential_code. 20260910090000 scoped the
  -- market gate to exactly those rows, and it was right to: a market pack
  -- governs which REGULATED credentials may be registered, and has no business
  -- deciding whether a holder may say where their driving licence came from.
  -- Asserting these with credential-less claims would be asserting a contract
  -- this database deliberately does not have.
  ...
  BEGIN
    ...
    VALUES (_h, 'licence', 'SIRA Security Cadre Card — Security Guard',
            'AE_DU_SIRA_CARD_GUARD', 'AE',
            'SIRA', current_date + 700, 'Fictional LLC');
  ...
  BEGIN
    ...
    VALUES (_h, 'licence', 'SIRA Security Cadre Card — Security Guard',
            'AE_DU_SIRA_CARD_GUARD', 'AE', 'AE-FU',
            'SIRA', current_date + 700, 'Fictional LLC');
