...
-- PR-R2A (20261024090000 / 20261025090000): the audience entry points, the
-- brief projection and the shared read predicate. The predicate is evaluated
-- by the two snapshot row policies, which CASCADE removes with it; the table
-- itself goes with the Phase 2b unwind further down.
