...
- [ ] Auth and role entry: compact, clear candidate/employer paths
- [ ] Employer experience: overview, onboarding, job creation and applications
- [x] Career and assessment presentation
- [x] Shared navigation, states, SV/EN and legal surfaces
- [ ] Desktop/tablet/390px/375px Preview evidence and accessibility checks
- [ ] Typecheck, lint, build and focused regression suites
- [ ] Branch commit, draft PR if available, final owner-review report
