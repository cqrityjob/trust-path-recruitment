...
| TRUST · strategiska och ledande roller | Ja, som **granskningsutkast** i migrationen `20261216090000` (2026-09-26): kravprofil, kandidattest 37 uppgifter, intervjuguide `security-manager-se` v1, rubriker, rapportfrågor | Nej (migrationen är inte tillämpad; blir installerad som ej aktiverat utkast) | Nej – kräver samlat innehållsgodkännande och därefter aktivering, se `docs/release/2026-09-26-strategic-level-content-approval.md` |
...
| TRUST | Strategiska och ledande roller (Security Manager / säkerhetschef) | **2 – Finns som granskningsutkast, ej aktiverat** (2026-09-26) | Allt enligt 3.1 författat som utkast i `20261216090000`: kravprofil (roll + sex beteenden), kandidattest *Säkerhetschef – Recruitment Assessment* (37 uppgifter, 5 delar, 3 rubriker), intervjuguide *Säkerhetschef* v1 (8 frågor), rapportfrågor. Granskningsförslag: `docs/assessment/security-manager-recruitment-review-proposal.md`. Nivån visas för kunden som utkast som väntar på godkännande; väktarinnehållet erbjuds aldrig under den rubriken. | Samlat innehållsgodkännande (fem grindar per uppgift; expert-, juridik-, kognitiv granskning av guiden) och därefter ett aktiveringsbeslut, se `docs/release/2026-09-26-strategic-level-content-approval.md`. |
