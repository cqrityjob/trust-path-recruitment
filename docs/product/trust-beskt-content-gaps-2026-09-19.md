...
| TRUST · strategiska och ledande roller | Ja, som **granskningsutkast** i migrationen `20261216090000` (2026-09-26): kravprofil, kandidattest 37 uppgifter, intervjuguide `security-manager-se` v1, rubriker, rapportfrågor; aktiverat på samma villkor som väktarinnehållet i `20261217090000` (sluten test / pilotversion) | Nej (migrationerna är inte tillämpade) | Nej – samlat innehållsgodkännande begärt, se `docs/release/2026-09-26-strategic-level-content-approval.md`; tills dess visas testet som sluten test/utkast |
...
| TRUST | Strategiska och ledande roller (Security Manager / säkerhetschef) | **3 – Finns som granskningsutkast, aktiverat som sluten test på samma villkor som väktarnivån** (2026-09-26) | Allt enligt 3.1 författat som utkast i `20261216090000`: kravprofil (roll + sex beteenden), kandidattest *Säkerhetschef – Recruitment Assessment* (37 uppgifter, 5 delar, 3 rubriker), intervjuguide *Säkerhetschef* v1 (8 frågor), rapportfrågor. `20261217090000` utpekar testet och öppnar guidens pilot – samma två akter som väktarinnehållet fick. Granskningsförslag: `docs/assessment/security-manager-recruitment-review-proposal.md`. Kunden kan skicka testet; det visas som sluten test (pilotversion), aldrig som validerat; väktarinnehållet erbjuds aldrig under den rubriken. | Samlat innehållsgodkännande (fem grindar per uppgift; expert-, juridik-, kognitiv granskning av guiden), se `docs/release/2026-09-26-strategic-level-content-approval.md`. |
