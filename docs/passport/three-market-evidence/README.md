...
| File                                                 | What it shows                                                                                                             |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `chromium-sv-harness-three-markets.png`              | The fixture screen, Swedish: market cards (public and pilot member), then the SE 3/5, GB 7/6, GB-NI 1/0 and AE-DU 15/15 catalogues |
