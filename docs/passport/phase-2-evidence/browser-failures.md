# Combined-head browser failures

All listed outcomes come from the complete 1,497-case run. Error text is retained in browser-results.json and browser-full.log.gz.
...
| my-career-home.spec.ts:164 | chromium | /my-career — the real route › 6 · a pending emailed invitation appears during the same visit |
...
| my-career-home.spec.ts:164 | mobile-390 | /my-career — the real route › 6 · a pending emailed invitation appears during the same visit |
...
| passport-first-run.spec.ts:1039 | chromium | Security Passport — the first run › 14 · a legacy completed profile with no merit gets the first-merit state |
| passport-first-run.spec.ts:1051 | chromium | Security Passport — the first run › 15 · only a draft merit is not Passport content |
| passport-first-run.spec.ts:1142 | chromium | Security Passport — the first run › 19 · the English journey renders in English throughout |
| passport-first-run.spec.ts:1164 | chromium | Security Passport — the first run › 20 · keyboard only: choose, fill, declare and save without a mouse |
| passport-first-run.spec.ts:1554 | chromium | Security Passport — the first run › 24 · a direct signup with ?redirect=/passport lands in the journey |
| passport-first-run.spec.ts:1570 | chromium | Security Passport — the first run › 25 · the emailed confirmation link comes back to /passport |
| passport-first-run.spec.ts:1039 | mobile-375 | Security Passport — the first run › 14 · a legacy completed profile with no merit gets the first-merit state |
| passport-first-run.spec.ts:1051 | mobile-375 | Security Passport — the first run › 15 · only a draft merit is not Passport content |
| passport-first-run.spec.ts:1142 | mobile-375 | Security Passport — the first run › 19 · the English journey renders in English throughout |
| passport-first-run.spec.ts:1164 | mobile-375 | Security Passport — the first run › 20 · keyboard only: choose, fill, declare and save without a mouse |
| passport-first-run.spec.ts:1554 | mobile-375 | Security Passport — the first run › 24 · a direct signup with ?redirect=/passport lands in the journey |
| passport-first-run.spec.ts:1570 | mobile-375 | Security Passport — the first run › 25 · the emailed confirmation link comes back to /passport |
| passport-first-run.spec.ts:1039 | mobile-390 | Security Passport — the first run › 14 · a legacy completed profile with no merit gets the first-merit state |
| passport-first-run.spec.ts:1051 | mobile-390 | Security Passport — the first run › 15 · only a draft merit is not Passport content |
| passport-first-run.spec.ts:1142 | mobile-390 | Security Passport — the first run › 19 · the English journey renders in English throughout |
| passport-first-run.spec.ts:1164 | mobile-390 | Security Passport — the first run › 20 · keyboard only: choose, fill, declare and save without a mouse |
| passport-first-run.spec.ts:1554 | mobile-390 | Security Passport — the first run › 24 · a direct signup with ?redirect=/passport lands in the journey |
| passport-first-run.spec.ts:1570 | mobile-390 | Security Passport — the first run › 25 · the emailed confirmation link comes back to /passport |
