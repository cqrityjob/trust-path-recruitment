...
3. **VU1, VU2 and SV — resolved by 20261126090000 (2026-09-18).** VU1/VU2 are listed with a document-stated issuer under a governed regulator; SV is listed with a required scope. No issuer or territorial metadata was invented. See [closed-catalogue-governance.md](closed-catalogue-governance.md) and the [coverage matrix](catalogue-coverage-matrix.md).
